...
@XmlRootElement(name = "list_input", namespace = "http://docs.oasis-open.org/xmile/ns/XMILE/v1.0")
public class ListInput {

    @XmlElement(name = "numeric_input", namespace = "http://docs.oasis-open.org/xmile/ns/XMILE/v1.0")
    protected List<NumericInput> numericInput;
     ...
     * This is why there is not a <CODE>set</CODE> method for the numericInput property.
     *
     * <p>
     ...
     *
     */
    public List<NumericInput> getNumericInput() {
        if (numericInput == null) {
            numericInput = new ArrayList<NumericInput>();
        }
    ...
    public static class NumericInput {
        ...
        protected ListInput.NumericInput.Entity entity;
