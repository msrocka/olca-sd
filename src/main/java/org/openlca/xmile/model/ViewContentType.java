...
@XmlType(name = "view_content_type", namespace = "http://docs.oasis-open.org/xmile/ns/XMILE/v1.0", propOrder = {
    "styleOrStockOrFlow"
})
@XmlSeeAlso({
    Views.View.class,
...
public class ViewContentType {
    ...
    @XmlElements({
        ...
        @XmlElement(name = "connector", namespace = "http://docs.oasis-open.org/xmile/ns/XMILE/v1.0", type = Connector.class),
        @XmlElement(name = "alias", namespace = "http://docs.oasis-open.org/xmile/ns/XMILE/v1.0", type = Alias.class),
        @XmlElement(name = "text_box", namespace = "http://docs.oasis-open.org/xmile/ns/XMILE/v1.0", type = TextBox.class),
        @XmlElement(name = "graphics_frame", namespace = "http://docs.oasis-open.org/xmile/ns/XMILE/v1.0", type = GraphicsFrame.class),
        @XmlElement(name = "graph", namespace = "http://docs.oasis-open.org/xmile/ns/XMILE/v1.0", type = Graph.class),
        @XmlElement(name = "table", namespace = "http://docs.oasis-open.org/xmile/ns/XMILE/v1.0", type = Table.class),
        @XmlElement(name = "button", namespace = "http://docs.oasis-open.org/xmile/ns/XMILE/v1.0", type = Button.class),
        @XmlElement(name = "slider", namespace = "http://docs.oasis-open.org/xmile/ns/XMILE/v1.0", type = Slider.class),
        @XmlElement(name = "knob", namespace = "http://docs.oasis-open.org/xmile/ns/XMILE/v1.0", type = Knob.class),
        @XmlElement(name = "list_input", namespace = "http://docs.oasis-open.org/xmile/ns/XMILE/v1.0", type = ListInput.class),
        @XmlElement(name = "numeric_display", namespace = "http://docs.oasis-open.org/xmile/ns/XMILE/v1.0", type = NumericDisplay.class),
        @XmlElement(name = "switch", namespace = "http://docs.oasis-open.org/xmile/ns/XMILE/v1.0", type = Switch.class),
        @XmlElement(name = "graphical_input", namespace = "http://docs.oasis-open.org/xmile/ns/XMILE/v1.0", type = GraphicalInput.class),
        @XmlElement(name = "stacked_container", namespace = "http://docs.oasis-open.org/xmile/ns/XMILE/v1.0", type = StackedContainer.class),
        @XmlElement(name = "options", namespace = "http://docs.oasis-open.org/xmile/ns/XMILE/v1.0", type = Options.class)
    })
    ...
    public static class Button {
        ...
        @XmlElement(name = "menu_action", namespace = "http://docs.oasis-open.org/xmile/ns/XMILE/v1.0")
        protected ViewContentType.Button.MenuAction menuAction;
        @XmlElement(name = "switch_action", namespace = "http://docs.oasis-open.org/xmile/ns/XMILE/v1.0")
         ...
         *
         */
        public void setMenuAction(MenuAction value) {
    ...
    public static class Connector {
        ...
        public static class From {
             ...
             * <p>
             * Objects of the following type(s) are allowed in the list
             * {@link JAXBElement }{@code <}{@link Alias }{@code >}
             * {@link String }
             *
             *
             */
