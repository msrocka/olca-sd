...
@XmlRootElement(name = "numeric_display", namespace = "http://docs.oasis-open.org/xmile/ns/XMILE/v1.0")
public class NumericDisplay {

    @XmlElement(namespace = "http://docs.oasis-open.org/xmile/ns/XMILE/v1.0", required = true)
    protected NumericDisplay.Entity entity;
    @XmlAttribute(name = "show_name")
    protected Boolean showName;
    @XmlAttribute(name = "retain_ending_value")
    protected Boolean retainEndingValue;
    ...
    /**
     * Gets the value of the retainEndingValue property.
     *
     * @return
     *     possible object is
     *     {@link Boolean }
     *
     */
    public boolean isRetainEndingValue() {
        if (retainEndingValue == null) {
            return false;
        } else {
            return retainEndingValue;
        }
    }

    /**
     * Sets the value of the retainEndingValue property.
     *
     * @param value
     *     allowed object is
     *     {@link Boolean }
     *
     */
    public void setRetainEndingValue(Boolean value) {
        this.retainEndingValue = value;
    }
