...
@XmlRootElement(name = "graphical_input", namespace = "http://docs.oasis-open.org/xmile/ns/XMILE/v1.0")
public class GraphicalInput {

    @XmlElement(namespace = "http://docs.oasis-open.org/xmile/ns/XMILE/v1.0", required = true)
    protected GraphicalInput.Entity entity;
